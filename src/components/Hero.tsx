        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-end pb-16">
          ...
          >
            <p
              ...
              style={{ color: 'var(--on-surface-variant)', fontFamily: 'var(--font-body)' }}
            >
              Software engineer with 3+ years building production-scale backend systems and
              AI-driven applications. Specialized in deploying ML models, scalable APIs, and
            ...
            >
              ...
              <MagneticElement className="w-full sm:w-auto">
                <motion.a
                  ...
                  animate={{
                    boxShadow: [
                      '0 0 0px rgba(255,146,73,0)',
                      '0 0 15px rgba(255,146,73,0.3)',
                      '0 0 0px rgba(255,146,73,0)',
                    ],
                    borderColor: [
