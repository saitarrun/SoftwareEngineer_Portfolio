...
const ExperienceCard = ({ exp, index }: { exp: any, index: number }) => {
    ...
    return (
        <motion.div
            ...
            className="group grid md:grid-cols-[100px_1fr] gap-8 md:gap-16 p-10 md:p-14 rounded-[2.5rem] transition-all duration-700 bg-surface-container-low/40 backdrop-blur-xl ghost-border hover:bg-surface-container-low hover:border-primary/40 hover:shadow-[0_0_50px_rgba(255,146,73,0.1)] w-full relative h-full"
        >
            {/* Number Layer */}
