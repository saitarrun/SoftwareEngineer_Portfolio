        ...
        >
            ...
            <div style={{ transform: "translateZ(30px)" }}>
                ...
                <div className="flex flex-wrap gap-3 mb-10" style={{ transform: "translateZ(40px)" }}>
                    <span className="text-[10px] font-bold uppercase tracking-[0.4em] px-5 py-2.5 rounded-lg bg-surface-container-highest/60 text-on-surface-variant border border-white/05 backdrop-blur-md" style={{ fontFamily: 'var(--font-label)' }}>
                        {edu.period}
                    </span>
                    <span className="text-[10px] font-bold uppercase tracking-[0.4em] px-5 py-2.5 rounded-lg bg-surface-container-highest/60 text-on-surface-variant border border-white/05 backdrop-blur-md" style={{ fontFamily: 'var(--font-label)' }}>
                        {edu.location}
                ...
                <div className="space-y-4 max-w-4xl">
                    {(Array.isArray(edu.description) ? edu.description : [edu.description]).map((item: string, i: number) => (
                        <p key={i} className="text-xl text-on-surface-variant leading-relaxed group-hover:text-on-surface/90 transition-colors duration-500" style={{ fontFamily: 'var(--font-body)' }}>{item}</p>
                    ))}
                </div>
            </div>
        </motion.div>
