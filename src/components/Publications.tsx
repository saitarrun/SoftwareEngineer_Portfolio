            ...
            <GlassCard className="p-8 md:p-12 rounded-[2.5rem] border border-white/10 hover:border-primary/50 transition-all duration-300 cursor-pointer hover:shadow-[0_0_30px_rgba(255,146,73,0.1)]">
              ...
              <div className="space-y-4">
                ...
                <p className="text-on-surface-variant text-base leading-relaxed">
                  Post-deployment analysis of dormant hardware Trojans in integrated circuits using
                  power side-channel analysis and Random Forest models. Achieved 98% detection
                  accuracy while reducing computational costs and improving noise robustness.
                </p>
              </div>
            </GlassCard>
          </a>
